          ...
          <div class="card-box">
                ...
                <li class="unread">
                  ...
                  <div class="col-mail col-mail-2">
                    <a href="<?= base_url('backend/pengaduan/detail/') . $data['id']?>"
                      ...
                      <span class="teaser"><?= $data['email']?> - <?= $data['saran']?></span>
                    </a>
                    <small class="date" style="font-size: 10px;"><?= $data['created_at']?></small>
                  </div>
                </li>
                <?php endforeach;?>
              </ul>
            ...
            <div class="row">
              <div class="col-7 mt-1">
                Showing 1 - <?php echo $pengaduan_row. " of ". $pengaduan_row?>
              </div> <!-- end col-->
              <div class="col-5">
